...
export function DefaultSettingsDialog() {
  ...
  const [existingMapLocations, setExistingMapLocations] = useLocalStorageState<Record<string, string>>('mapLocations', {
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-8 items-center gap-4">
            ...
            <Input
              ...
              className="col-span-3"
            />
            <Button onClick={handleAddLocation} className="col-span-4">Add Location</Button>
          </div>
        </div>
         <Table>
            <TableHeader>
